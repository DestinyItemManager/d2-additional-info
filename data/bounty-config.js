...
// enemyType
  { assign: { enemyType: 'Taken',                }, matches: [/\btaken\b/],                                                        test: ['desc', 'name'] },
  { assign: { enemyType: 'Cabal',                }, matches: [/\bcabal\b/],                                                        test: ['desc', 'name'] },
  { assign: { enemyType: 'Fallen',               }, matches: [/\bfallen\b/],                                                       test: ['desc', 'name'] },
  { assign: { enemyType: 'Scorn',                }, matches: [/\bscorn\b/],                                                        test: ['desc', 'name'] },
  { assign: { enemyType: 'Vex',                  }, matches: [/\bvex\b/],                                                          test: ['desc', 'name'] },
  { assign: { enemyType: 'Hive',                 }, matches: [/\bhive\b/],                                                         test: ['desc', 'name'] },
  ...
  { assign: { enemyType: 'Bosses',               }, matches: [/(?<!mini)bosses/],                                                  test: ['desc', 'name'] },
