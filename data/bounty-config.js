...
// damageType
  { assign: { damageType: 'Arc',        }, matches: [/\barc\b/i],   test: ['desc'] },
...
// enemyType
  ...
  { assign: { enemyType: 'Guardians',  }, matches: ['guardians are worth', /(defeat|opposing|enemy|other) guardians/i], test: ['desc', 'name'] },
...
// weaponType
  ...
  { assign: { weaponType: 'Grenade',             }, matches: [/grenade(?! launcher)/i],             test: ['desc'] },
  { assign: { weaponType: 'Headshot',            }, matches: ['headshot','precision'],              test: ['desc'] },
  { assign: { weaponType: 'Sword',               }, matches: ['sword'],                             test: ['desc'] },
  { assign: { weaponType: 'Machine Gun',         }, matches: [/(?<!sub)machine gun/i],              test: ['desc'] },
