...
| missing-source-info.ts                | a listing of sources and item hashes that were missing a source hash [DEPRECATED]                                                                                       |
...
| source-info.ts                        | a listing between tags and the sources associated with them [DEPRECATED]                                                                                                |
