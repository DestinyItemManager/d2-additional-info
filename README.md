...
| exotic-synergy.json                   | a listing between exotic armor hash and the subclass(es) it synergizes with                                                                                             |
...
| ghost-perks.json                      | an outdated listing of ghost perks, from before ghost 2.0                                                                                                               |
| item-def-workaround-replacements.json | deprecated mapping from placeholder weapons in postmaster to their actual hashes when pulled (last used in Dawn)                                                        |
